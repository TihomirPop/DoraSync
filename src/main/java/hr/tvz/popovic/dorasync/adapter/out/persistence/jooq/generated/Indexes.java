...
public class Indexes {
    ...
    public static final Index UX_JOB_STEPS_ONE_COMPUTE_METRICS_PER_JOB = Internal.createIndex(DSL.name("ux_job_steps_one_compute_metrics_per_job"), JobSteps.JOB_STEPS, new OrderField[] { JobSteps.JOB_STEPS.JOB_ID }, true);
